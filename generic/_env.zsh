...
alias work='docker run -it --rm -v ~/Downloads:/root/Downloads -h workspace -v workspace:/root/workspace -v m2:/root/.m2 baseline'
alias base='docker run -it --rm -v ~/Downloads:/root/Downloads -h baseline baseline'
